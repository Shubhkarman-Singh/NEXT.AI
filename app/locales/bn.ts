...
const bn: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Next.AI লঞ্চ অফার, এখনই OpenAI o1, GPT-4o, Claude-3.5 এবং সর্বশেষ বড় মডেলগুলি আনলক করুন",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    InputActions: {
      ...
      UploadImage: "ফাইল বা চিত্র আপলোড করুন",
    },
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Next.AI ব্যবহার করুন",
        Label: "(সবচেয়ে কার্যকরী সমাধান)",
        SubTitle:
          "Next.AI দ্বারা অফিসিয়ালি রক্ষণাবেক্ষণ করা হয়, কোনো কনফিগারেশন ছাড়াই ব্যবহারযোগ্য, OpenAI o1, GPT-4o, Claude-3.5 এবং আরও অনেক কিছু সমর্থন করে",
        ChatNow: "এখনই শুরু করুন",
      },

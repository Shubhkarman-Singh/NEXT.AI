...
const ru: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Промо Next.AI: мгновенно откройте доступ к OpenAI o1, GPT-4o, Claude-3.5 и другим новым моделям!",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    InputActions: {
      ...
      UploadImage: "Загрузить файлы или изображения",
    },
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Используйте Next.AI",
        Label: "(Самое экономичное решение)",
        SubTitle:
          "Официально поддерживается Next.AI, готов к использованию без настройки, поддерживает последние крупные модели, такие как OpenAI o1, GPT-4o и Claude-3.5",
        ChatNow: "Начать чат",
      },

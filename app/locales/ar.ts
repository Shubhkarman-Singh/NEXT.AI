...
const ar: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 عرض Next.AI الأول، افتح الآن OpenAI o1, GPT-4o, Claude-3.5 وأحدث النماذج الكبيرة",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    InputActions: {
      ...
      UploadImage: "تحميل ملفات أو صور",
    },
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "استخدم Next.AI",
        Label: "(الخيار الأكثر فعالية من حيث التكلفة)",
        SubTitle:
          "مدعوم رسميًا من Next.AI، جاهز للاستخدام دون إعداد، يدعم أحدث النماذج الكبيرة مثل OpenAI o1, GPT-4o وClaude-3.5",
        ChatNow: "ابدأ الآن",
      },
      AccessCode: {
